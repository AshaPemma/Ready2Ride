...
import com.warrous.ready2ride.groups.adapter.LatestDiscussionsAdapterFea;
...
public class DetailedGroupActivityFea extends BaseActivity implements DetailedGroupContract.View,LatestDiscussionsAdapterFea.OnItemClickListener{
    ...
    LatestDiscussionsAdapterFea latestDiscussionsAdapter;
...
//      //  mPresenter.getMembers(PreferenceManager.getIntegerValue(this,PreferenceManager.KEY_DEALER_ID));
        ...
        latestDiscussionsAdapter=new LatestDiscussionsAdapterFea(this,this,null);
    ...
    public void ongetDiscussionsSucess(ArrayList<DiscussionsResponse> discussionsResponseArrayList) {
        if(discussionsResponseArrayList!=null) {
            if (discussionsResponseArrayList.size() != 0) {
                ...
                rvLatestDiscussions.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
                latestDiscussionsAdapter=new LatestDiscussionsAdapterFea(this,this,discussionsResponseArrayList);
                rvLatestDiscussions.setAdapter(latestDiscussionsAdapter);
            }else{
