...
import com.warrous.ready2ride.groups.adapter.LatestDiscussionsAdapterDash;
...
public class DetailedGroupActivityDash extends BaseActivity implements DetailedGroupContract.View,LatestDiscussionsAdapterDash.OnItemClickListener{
    ...
    LatestDiscussionsAdapterDash latestDiscussionsAdapter;
...
//      //  mPresenter.getMembers(PreferenceManager.getIntegerValue(this,PreferenceManager.KEY_DEALER_ID));
        ...
        latestDiscussionsAdapter=new LatestDiscussionsAdapterDash(this,this,null);
    ...
    public void ongetDiscussionsSucess(ArrayList<DiscussionsResponse> discussionsResponseArrayList) {
        if(discussionsResponseArrayList!=null) {
            if (discussionsResponseArrayList.size() != 0) {
                ...
                rvLatestDiscussions.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
                latestDiscussionsAdapter=new LatestDiscussionsAdapterDash(this,this,discussionsResponseArrayList);
                rvLatestDiscussions.setAdapter(latestDiscussionsAdapter);
            }else{
