...
import com.warrous.ready2ride.auth.profile.ProfilePresenter;
...
public class SaveCommentActivty extends BaseActivity implements SaveCommentContract.View{
    ...
    SaveCommentContract.Presenter mPresenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_save_discussion_comment);
        ...
        mPresenter=new SaveCommentPresenter(this);
    ...
    public void onACtivityLoad(){
        ...
        ActivityUtils.startActivityFinish(this,DiscussionCommentsActivity.class,bundle);
    }
    ...
    public void onButtonSend(){
        ...
        mPresenter.createGroup(discussionCommentRequest);
    }
