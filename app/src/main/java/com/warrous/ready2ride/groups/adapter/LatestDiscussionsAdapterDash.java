...
public class LatestDiscussionsAdapterDash extends RecyclerView.Adapter<
            LatestDiscussionsAdapterDash.ViewHolder> {

        OnItemClickListener mItemClickListener;
    DetailedGroupActivityDash activity;
        ArrayList<DiscussionsResponse> discussionsResponses;



        public LatestDiscussionsAdapterDash(DetailedGroupActivityDash activity, OnItemClickListener mItemClickListener, ArrayList<DiscussionsResponse> discussionsResponses) {
