...
public class AttendingEventsAdapter extends RecyclerView.Adapter<
            AttendingEventsAdapter.ViewHolder> {

        OnItemClickListenerEvent mItemClickListener;
        Context activity;
        ...
        public AttendingEventsAdapter(Context activity, OnItemClickListenerEvent mItemClickListener, ArrayList<EventsPromotionsResponse> eventsPromotionsResponses) {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_attending_events, parent, false);
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            ...
            holder.tvDesc.setText(eventsPromotionsResponse.getDescription());
        ...
        public interface OnItemClickListenerEvent {
            void onItemClickEvent(View view, int position,EventsPromotionsResponse eventsPromotionsResponse);
        }

        public void setOnItemClickListener(final OnItemClickListenerEvent mItemClickListener) {
            this.mItemClickListener = mItemClickListener;
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                if (mItemClickListener != null) {
                    mItemClickListener.onItemClickEvent(v, getAdapterPosition(),eventsPromotionsResponses.get(getAdapterPosition()));
                }
