package com.warrous.ready2ride.tracksearch.parking;
...
import com.warrous.ready2ride.tracksearch.DirectionsActivityP;
...
public class ParkingActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, OnMapReadyCallback ,ParkingAdapter.OnItemClickListener{

    private MapView mapView;
    private GoogleMap gmap;
    ParkingAdapter findDealerAdapter;
...
//        }
        ...
        findDealerAdapter = new ParkingAdapter(this, this, null);
...
//        }
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                AndroidUtil.hideKeyBoard(ParkingActivity.this, etSearch);
    ...
    public void onItemClick(View view, int position, RestaurantResponse dealershipResponse) {
        ...
        ActivityUtils.startActivity(this,DirectionsActivityP.class,bundle);    }
...
//                gmap.addMarker(markerOptions);
    ...
    public void setMarkers(ArrayList<RestaurantResponse> dealershipResponses) {
        for (int i = 0; i < dealershipResponses.size(); i++) {
            BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.ic_park_blue);
...
// gmap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(dealershipResponses.get(0).getDealerLatitude()), Double.parseDouble(dealershipResponses.get(0).getDealerLongitude())), 10));
        ...
        public void setRecyclerView(ArrayList<RestaurantResponse> restaurantResponsesL){
            ...
            if(restaurantResponsesL.size()!=0){
                ...
                findDealerAdapter = new ParkingAdapter(this, this, restaurantResponsesL);
                rvDealerShipItems.setAdapter(findDealerAdapter);
            }else{
                    ...
                    if (ContextCompat.checkSelfPermission(this,
                        ...
                        if (mLastLocation != null) {
                           ...
                           // mPresenter.getParkingDetails( mLastLocation.getLatitude(), mLastLocation.getLongitude());
                            onGetData(String.valueOf(mLastLocation.getLatitude()),String.valueOf(mLastLocation.getLongitude()),"parking");
