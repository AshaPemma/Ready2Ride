...
public class GasStationsAdapter extends RecyclerView.Adapter<
        ...
        public GasStationsAdapter(Activity activity, OnItemClickListener mItemClickListener, ArrayList<RestaurantResponse> dealersList) {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_gas_station, parent, false);
