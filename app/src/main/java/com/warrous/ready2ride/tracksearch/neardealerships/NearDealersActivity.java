package com.warrous.ready2ride.tracksearch.neardealerships;
...
import com.warrous.ready2ride.finddealer.FindDealerContract;
import com.warrous.ready2ride.finddealer.FindDealerPresenter;
...
public class NearDealersActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, OnMapReadyCallback, FindDealerAdapter.OnItemClickListener, FindDealerContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_near_dealers);
      ...
      //  rvDealerShipItems.setAdapter(findDealerAdapter);
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                AndroidUtil.hideKeyBoard(NearDealersActivity.this,etSearch);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(NearDealersActivity.this,
...
//                _longitude.setText("Longitude: " + String.valueOf(mLastLocation.getLongitude()));
                            ...
                            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, NearDealersActivity.this);
                        }
                    }
...
//
       ...
       Bundle bundle=new Bundle();
        ...
        bundle.putDouble("EndLat",Double.parseDouble(dealershipResponse.getDealerLatitude()));
        bundle.putDouble("EndLong",Double.parseDouble(dealershipResponse.getDealerLongitude()));
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(NearDealersActivity.this, 1000);
                        } catch (IntentSender.SendIntentException e) {
                            // Ignore the error.
                        }
                        break;
