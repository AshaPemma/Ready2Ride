package com.warrous.ready2ride.tracksearch.gasstations;
...
import com.warrous.ready2ride.tracksearch.DirectionsActivityG;
...
public class GasStationsActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, OnMapReadyCallback ,GasStationsAdapter.OnItemClickListener {

    private MapView mapView;
    private GoogleMap gmap;
    GasStationsAdapter findDealerAdapter;
...
//        }
        ...
        findDealerAdapter = new GasStationsAdapter(this, this, null);
...
//        }
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                AndroidUtil.hideKeyBoard(GasStationsActivity.this, etSearch);
    ...
    public void onItemClick(View view, int position, RestaurantResponse dealershipResponse) {
        ...
        ActivityUtils.startActivity(this,DirectionsActivityG.class,bundle);
    }
...
//                gmap.addMarker(markerOptions);
    ...
    public void setMarkers(ArrayList<RestaurantResponse> dealershipResponses) {
        for (int i = 0; i < dealershipResponses.size(); i++) {
            BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.ic_gas_pointer_blue);
...
// gmap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(dealershipResponses.get(0).getDealerLatitude()), Double.parseDouble(dealershipResponses.get(0).getDealerLongitude())), 10));
        ...
        public void setRecyclerView(ArrayList<RestaurantResponse> restaurantResponsesL){
            ...
            if(restaurantResponsesL.size()!=0){
                ...
                findDealerAdapter = new GasStationsAdapter(this, this, restaurantResponsesL);
                rvDealerShipItems.setAdapter(findDealerAdapter);
            }else{
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(GasStationsActivity.this,
                    ...
                    if (ContextCompat.checkSelfPermission(this,
                        ...
                        if (mLastLocation != null) {
                           ...
                           // mPresenter.getParkingDetails( mLastLocation.getLatitude(), mLastLocation.getLongitude());
                            onGetData(String.valueOf(mLastLocation.getLatitude()),String.valueOf(mLastLocation.getLongitude()),"gasstations");
...
//                _longitude.setText("Longitude: " + String.valueOf(mLastLocation.getLongitude()));
                            ...
                            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, GasStationsActivity.this);
                        }
                    }
                    ...
                    switch (status.getStatusCode()) {
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                status.startResolutionForResult(GasStationsActivity.this, 1000);
                            } catch (IntentSender.SendIntentException e) {
                                // Ignore the error.
                            }
                            break;
