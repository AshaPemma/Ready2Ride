...
import com.warrous.ready2ride.tracksearch.DirectionsActivityC;
...
public class CafesActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, OnMapReadyCallback,CafesAdapter.OnItemClickListener {

    private MapView mapView;
    private GoogleMap gmap;
    CafesAdapter findDealerAdapter;
...
//        }
        ...
        findDealerAdapter = new CafesAdapter(this, this, null);
...
//        }
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                AndroidUtil.hideKeyBoard(CafesActivity.this, etSearch);
    ...
    public void onItemClick(View view, int position, RestaurantResponse dealershipResponse) {
        ...
        ActivityUtils.startActivity(this,DirectionsActivityC.class,bundle);
    }
    ...
    private String downloadUrl(String strUrl) throws IOException {
        ...
        Ready2RideLog.getInstance().info("URL",strUrl);
        String data = "";
...
//                gmap.addMarker(markerOptions);
    ...
    public void setMarkers(ArrayList<RestaurantResponse> dealershipResponses) {
        for (int i = 0; i < dealershipResponses.size(); i++) {
            BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.ic_cafe_pointer);
...
// gmap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(dealershipResponses.get(0).getDealerLatitude()), Double.parseDouble(dealershipResponses.get(0).getDealerLongitude())), 10));
        ...
        public void setRecyclerView(ArrayList<RestaurantResponse> restaurantResponsesL){
            ...
            if(restaurantResponsesL.size()!=0){
                ...
                findDealerAdapter = new CafesAdapter(this, this, restaurantResponsesL);
                rvDealerShipItems.setAdapter(findDealerAdapter);
            }else{
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(CafesActivity.this,
                    ...
                    if (ContextCompat.checkSelfPermission(this,
                        ...
                        if (mLastLocation != null) {
                           ...
                           // mPresenter.getParkingDetails( mLastLocation.getLatitude(), mLastLocation.getLongitude());
                            onGetData(String.valueOf(mLastLocation.getLatitude()),String.valueOf(mLastLocation.getLongitude()),"cafe");
...
//                _longitude.setText("Longitude: " + String.valueOf(mLastLocation.getLongitude()));
                            ...
                            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, CafesActivity.this);
                        }
                    }
                    ...
                    switch (status.getStatusCode()) {
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                status.startResolutionForResult(CafesActivity.this, 1000);
                            } catch (IntentSender.SendIntentException e) {
                                // Ignore the error.
                            }
                            break;
