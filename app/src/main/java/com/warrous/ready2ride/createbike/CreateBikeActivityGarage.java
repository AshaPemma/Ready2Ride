...
public class CreateBikeActivityGarage extends BaseActivity implements CreateBikeContract.View{
...
//            Log.e("ERROR",e.getMessage());
    ...
    private void bindAdapter() {
        ...
        yearobj.setYearId(-1);
        yearobj.setYearValue("Select Year");
        yearList.add(yearobj);


        Model model=new Model();
        model.setBrandId(-1);
        model.setModelName("Select Model");
        modelList.add(model);

        Brand brand=new Brand();
        brand.setBrandId(-1);
        brand.setBrandName("Select Brand");
        brandList.add(brand);
...
//        }
    ...
    public void onSUceesModels(ArrayList<Model> modelsList) {
        ...
        modelobj.setModelName("Select Model");
